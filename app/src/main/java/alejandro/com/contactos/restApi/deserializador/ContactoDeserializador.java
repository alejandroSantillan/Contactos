package alejandro.com.contactos.restApi.deserializador;
...
import alejandro.com.contactos.restApi.JsonKeys;
...
public class ContactoDeserializador implements JsonDeserializer<ContactoResponse> {
    ...
    private List<Contacto> deserializarContactoDeJson(JsonArray contactoResponseData){
